...
proc get_length
	...
	je case32
case1:
     mov [selectedWordLen],10
	 mov [choose],1
	 mov [was],0
	 jmp endl
case2:
      mov [selectedWordLen],19
	  mov [choose],2
	  mov [was],1
	  jmp endl
case3:
      mov [selectedWordLen],16
	  mov [choose],3
	  mov [was],2
	  jmp endl
case4:
      mov [selectedWordLen],13
	 mov [was],3
	  mov [choose],4
	  jmp endl
case5:
      mov [selectedWordLen],8
	  mov [was],4
	  mov [choose],5
	  jmp endl
case6:
      mov [selectedWordLen],15
	  mov [was],5
	  mov [choose],6
	  jmp endl
case7:
      mov [selectedWordLen],12
	  mov [was],6
	  mov [choose],7
	  jmp endl
case8:
      mov [selectedWordLen],11
	  mov [was],7
	  mov [choose],8
	  jmp endl
case9:
...
first:
	...
	jmp typee
clean_screen:
    ;clear the screen from the massege of the 30 seconds
    MoveGrafic
...
proc check_word
	...
	mov [correct], 0
	;check if the length of the input word and correct word are not the same
	mov al, [countSt]
	cmp al, [selectedWordLen]
	jne lostt
